...
<<<<<<< HEAD
			...
			this->pictureBox1->ImageLocation = L"C:\\Users\\Miguel 07\\source\\repos\\probabilidades\\estadistica\\imagenes\\1.png";
			this->pictureBox1->InitialImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.InitialImage")));
			this->pictureBox1->Location = System::Drawing::Point(51, 69);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(646, 398);
			...
			this->label2->Size = System::Drawing::Size(329, 38);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Proyecto de Estadistica";
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(276, 172);
